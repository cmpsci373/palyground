...
function createSurface() {
	...
	/*
	mesh.vertices.push(new THREE.Vector3(-1,  1, 0));
	mesh.vertices.push(new THREE.Vector3( 1,  1, 0));
	mesh.vertices.push(new THREE.Vector3(-1, -1, 0));
	mesh.vertices.push(new THREE.Vector3( 1, -1, 0));
				
	mesh.faces.push(new THREE.Face3(0, 2, 1));
	mesh.faces.push(new THREE.Face3(1, 2, 3));
	*/
	/*
	const N=10;
	for(let j=0;j<=N;j++) {
		for(let i=0;i<=N;i++) {
			mesh.vertices.push(new THREE.Vector3(i/N-0.5, 0.5-j/N, 0));
		}
	}
	...
	for(let j=0;j<N;j++) {
		for(let i=0;i<N;i++) {
			let idx=j*(N+1)+i;
			mesh.faces.push(new THREE.Face3(idx,   idx+1, idx+(N+1)));
			mesh.faces.push(new THREE.Face3(idx+1,idx+(N+1), idx+(N+2)));
		}
	}*/
	/*
	const N=100;
	for(let j=0;j<=N;j++) {
		for(let i=0;i<=N;i++) {
			let x=i/N-0.5;
			let y=0.5-j/N;
			let z=0.05*Math.sin(20*Math.sqrt(x*x+y*y));
	...
	for(let j=0;j<N;j++) {
		for(let i=0;i<N;i++) {
			let idx=j*(N+1)+i;
			mesh.faces.push(new THREE.Face3(idx,  idx+(N+1), idx+1));
			mesh.faces.push(new THREE.Face3(idx+1,idx+(N+1), idx+(N+2)));
		}
	}
	*/
